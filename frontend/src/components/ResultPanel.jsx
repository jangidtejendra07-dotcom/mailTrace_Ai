import {
  ...
  GitBranch, FileDown, AlertTriangle, ShieldCheck,
} from 'lucide-react'
import RiskGauge from './RiskGauge.jsx'
import ScoreBar from './ScoreBar.jsx'
import Panel from './Panel.jsx'
import GeoMap from './GeoMap.jsx'
import { reportUrl } from '../lib/api.js'
...
export default function ResultPanel({ result }) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
      {/* Left: verdict + case */}
      <Panel title="Verdict" icon={ShieldCheck} className="lg:col-span-1">
        <div className="flex flex-col items-center py-2">
          ...
          <a
            href={reportUrl(result.case_id)}
            className="mt-5 w-full inline-flex items-center justify-center gap-2 rounded-lg border border-trace/40 bg-trace/10 text-trace text-xs font-medium py-2.5 hover:bg-trace/20 transition-colors"
            download
          >
